#############################################################
# ~/Brewfile - Zach Brown's Mac Setup                       #
#                                                           #
...
brew 'jq'             # JSON parser and query tool
...
cask 'qlcolorcode'     # QL for code with syntax highlighting
cask 'qlmarkdown'      # QL for rendered markdown files
